...
import { ThemeIconProps, themeIconVariant } from './moon-icon';

export default function SunIcon({ onClick }: ThemeIconProps) {
  // Icon from: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools

  return (
    <motion.svg
      variants={themeIconVariant}
      initial="initial"
      animate="animate"
      viewBox="0 0 24 24"
      fill="none"
